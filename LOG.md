...
```
**vless_full.log** — это главный лог, который собирает вывод всех трёх этапов. Если что-то пошло не так, смотри сюда в первую очередь. Успешное завершение помечается ✅.
