...
# -------------------- АВТОВЫГРУЗКА СТАТИСТИКИ --------------------
# Период автоматической отправки /status в Telegram (в МИНУТАХ).
#
#   0   — не выгружать (по умолчанию выключено)
#   60  — раз в час
#   30  — раз в полчаса
#   120 — раз в 2 часа
#
# Первая отправка происходит через указанный интервал ПОСЛЕ старта
# бота (не сразу), чтобы не спамить при каждом перезапуске службы.
STATS_INTERVAL_MINUTES = 0
